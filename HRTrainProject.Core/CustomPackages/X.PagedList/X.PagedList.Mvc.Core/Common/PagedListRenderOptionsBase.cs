...
namespace X.PagedList.Mvc.Common
{
    public class PagedListRenderOptionsBase
    {
        ...
        public PagedListRenderOptionsBase()
        {
            ...
            EllipsesFormat = "&#8230;";
            LinkToFirstPageFormat = @"<i class=""angle double left icon""></i>";
            LinkToPreviousPageFormat = @"<i class=""left chevron icon""></i>";
            LinkToIndividualPageFormat = "{0}";
            LinkToNextPageFormat = @"<i class=""right chevron icon""></i>";
            LinkToLastPageFormat = @"<i class=""angle double right icon""></i>";
            ...
            UlElementClasses = new[] { "ui right floated pagination menu" };
            LiElementClasses = Enumerable.Empty<string>();
            PageClasses = new[] { "item" };
            UlElementattributes = null;
            ActiveLiElementClass = "active";
            EllipsesElementClass = "";
            PreviousElementClass = "icon";
            NextElementClass = "icon";
        }
